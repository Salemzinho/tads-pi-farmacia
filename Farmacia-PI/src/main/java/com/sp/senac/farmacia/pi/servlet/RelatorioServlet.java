 ...
 * @author vinis
 */
@WebServlet(name = "RelatorioServlet", urlPatterns = {"/protegido/relatorio/RelatorioServlet"})
public class RelatorioServlet extends HttpServlet {
    ...
    private static String LIST_PRO = "/protegido/relatorio/listaRelatorio.jsp";
